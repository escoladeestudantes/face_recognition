...
unknown_image = face_recognition.load_image_file("Buneco_Eko.jpg")

# Find all the faces and face encodings in the unknown image
face_locations = face_recognition.face_locations(unknown_image, 0, 'cnn')
